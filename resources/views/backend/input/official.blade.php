...
Kementerian Perdagangan Republik Indonesia | Buat Pejabat
@endsection
	...
	<div class="row">
		...
		<div class="col-12">
			<div class="card card-danger card-outline">
				<div class="card-body">
					{!! Form::open(array('route' => 'official.store','method'=>'POST', 'class' => 'form-horizontal', 'files' => 'true')) !!}
					@csrf
					<div class="row">
						<div class="col-3">
					...
					<div class="row">
						...
						<div class="col-3">
							...
							<div class="input-group">
								{!! Form::text('en_title', null, array('placeholder' => 'Judul','class' => 'form-control')) !!}
							</div>
						</div>
					</div>
					<br>
