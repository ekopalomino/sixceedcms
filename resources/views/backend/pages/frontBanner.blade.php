...
Kementerian Perdagangan Republik Indonesia | Banner Depan
@endsection
						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<div class="modal-body">
									{!! Form::open(array('route' => 'fnban.store','method'=>'POST', 'class' => 'form-horizontal', 'files'=>'true')) !!}
									@csrf
									...
									<div class="form-group row">
										<label for="inputEmail" class="col-sm-2 col-form-label">Posisi (Diisi Untuk Selain Tipe Popup)</label>
										<div class="col-sm-10">
											{!! Form::number('position', null, array('placeholder' => 'Urutan Banner','class' => 'form-control')) !!}
										</div>
									</div>
									<div class="form-group row">
										<label for="inputEmail" class="col-sm-2 col-form-label">Link Banner</label>
										<div class="col-sm-10">
											{!! Form::text('link', null, array('placeholder' => 'Link Banner','class' => 'form-control')) !!}
										</div>
									</div>
									<div class="form-group row">
										<label for="inputEmail" class="col-sm-2 col-form-label">Gambar Banner</label>
										<div class="col-sm-10">
											{!! Form::file('image', null, array('placeholder' => 'Image','class' => 'form-control')) !!}
										</div>
									</div>
									<div class="form-group row">
										<label for="inputEmail" class="col-sm-2 col-form-label">Deskripsi Banner</label>
										<div class="col-sm-10">
