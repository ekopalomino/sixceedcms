<nav class="main-header navbar navbar-expand navbar-white navbar-light">
	<ul class="navbar-nav">
		...
		<li class="nav-item d-none d-sm-inline-block">
			<a href="{{ route('config.index') }}" class="nav-link {{set_active(['config.index','user.index','roles.index','roles.create','log.index','country.index','region.index','city.index','dutycat.index','articlecat.index']) }}">Konfig</a>
		</li>
		<li class="nav-item d-none d-sm-inline-block">
